                        ...
                        <form class="form card card-body mb-4 shadow" enctype="multipart/form-data" method="POST" id="registrationForm">
                            ...
                            <div class="col-md-12 ">
                                <div class="text-center ">
                                    <?php echo '<img src="img/' . $row["profile_img"] . '" width="150" class="avatar rounded-circle img-thumbnail" alt="avatar">' ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 ">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name" placeholder="first name" value="<?php echo $row["ad_fname"] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 ">
                                    ...
                                    <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo $row["ad_lname"] ?>" placeholder="last name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 ">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email" value="<?php echo $row["ad_email"] ?>" placeholder="enter email" required>
                                </div>
                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $q = mysqli_query($conn, "UPDATE `admin` SET `ad_fname`='$first_name',`ad_lname`='$last_name',`ad_email`='$email',`ad_password`='$password',`profile_img`='$img_name' WHERE ad_id = '$id[0]'");
    if ($q) {
