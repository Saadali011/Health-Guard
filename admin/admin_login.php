            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <img src="img/Cute_woman_Doctor_holding_syringe_vaccine_hand_drawn_cartoon_art_illustration.jpg" height="550px" class="col-lg-6 d-none d-lg-block ">
